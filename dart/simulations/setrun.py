...
#------------------------------
    ...
    clawdata.inratx = [4,6,5]
    clawdata.inraty = [4,6,5]
...
#-------------------
    ...
    topodir = '/Users/rjl/svn/tsunami-benchmarks/honshu/topo/'
    ...
    geodata.dtopofiles.append([1,4,4,dtopodir+'pmelWei.txydz'])
    ...
    geodata.regions.append([4, 4, 0., 1000., 140,146,35,41])
